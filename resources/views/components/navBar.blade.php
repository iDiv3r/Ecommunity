...
<div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions" aria-labelledby="offcanvasWithBothOptionsLabel">
    <div class="offcanvas-header">
        <h5 class="offcanvas-title fw-bold ms-3" id="offcanvasWithBothOptionsLabel">Menú</h5>
    ...
    <div class="offcanvas-body">
        <ol class="list-group list-group list-group-flush">
            ...
            <li class="list-group-item">
                <a class="btn btn-success my-3" href={{route('irListaEmpresas')}}>Lista de empresas</a>
            </li>
            
            <li class="list-group-item">
                <a class="btn btn-success my-3" href={{route('irPuntosRecoleccion')}}>Puntos de recolección</a>
            </li>

            <li class="list-group-item">
                <a class="btn btn-success my-3" href={{route('irMisRecolecciones')}}>Mis recolecciones</a>
            </li>

            <li class="list-group-item">
                <a class="btn btn-success my-3" href={{route('irListaUsuarios')}}>Lista de usuarios</a>
            </li>

            <li class="list-group-item">
                <a class="btn btn-success my-3">Mi cuenta</a>
            </li>
        </ol>
    </div>
</div>
